# Operator Quickstart — Manufacture of Communication Equipment

Shortest path from clone to a verified local dry-run for **ISIC 2630** (`cloud-itonami-isic-2630`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2630.git
cd cloud-itonami-isic-2630
```
...
- Blueprint governor key: `commsdevice-governor`
- Likely source path: `commsdevice.governor.cljc`
