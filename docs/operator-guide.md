...
UI sample: `docs/samples/operator-console.html` — generated by
`clojure -M:dev:render-html`, which drives the real actor and renders the
resulting store + audit ledger. Nothing on that page is hand-typed.
